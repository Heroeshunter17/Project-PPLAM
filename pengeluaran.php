    ...
    <div class="row mt-2"> 
        <div class="row" >
            ...
            <div class="col">
                ...
                <input type="text" id="jumlah_produk" name="jumlah_produk" id="<?= $setFitur?>" class="form-control" placeholder="Jumlah Produk" aria-describedby="basic-addon2" style="width: 200px;">
                
            </div>
            <div class="col">
                
                <input type="text" id="keuntungan" name="keuntungan" id="<?= $setFitur?>" class="form-control" placeholder="Keuntungan" aria-describedby="basic-addon2" style="width: 200px;">
                
            </div>
            <div class="col">
                
                <button type="submit" name="submit" id="<?= $setFitur?>" class="btn btn-secondary"><i class="bi bi-sd-card me-2"></i>Simpan</button>
                
            </div>

</form>
                
                <strong class="mt-4"> Harga Jual : <?= rupiah($harga_jual['harga'])?></strong>
